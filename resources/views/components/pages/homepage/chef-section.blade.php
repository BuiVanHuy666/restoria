    ...
    <div class="auto-container">
        ...
        <div class="row clearfix">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="title-box">
                    <div class="subtitle"><span>Đầu bếp của chúng tôi</span></div>
                    <h2>Bếp trưởng Lorenzo</h2>
                    <p>
                        Một bậc thầy ẩm thực cao cấp, người tạo nên những món ăn tinh tế bằng sự chính xác,
                        niềm đam mê và óc sáng tạo vô hạn. Ông mang đến những trải nghiệm ẩm thực khó quên
                        với những hương vị thanh tao và đẳng cấp.
                    </p>
                </div>
            </div>
